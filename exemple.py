...
c = CGP(dfs=[df_EZ_prerecon_CS,df_EZ_prerecon_FS],d_vect_tot=d_vect_tot,param=param,covs=None)
...
c = CGP(dfs=[df_EZ_prerecon_CS,df_EZ_prerecon_FS],d_vect_tot=d_vect_tot,param=param,covs=[cov_config,cov_fourier])
